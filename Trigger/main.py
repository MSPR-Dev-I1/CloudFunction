    ...
    match api[2]:
        ...
        case "api-commande":
            ...
            return push_new_version(repo_path, clone_url, source_branch, github_user, github_user_email, decoded_message
                                    , repo_url, api[2])
        case "api-auth":
            clone_url = 'https://github.com/MSPR-Dev-I1/RepoVersion-API-Auth.git'
            repo_url = f'https://{github_user}:{github_token}@github.com/MSPR-Dev-I1/RepoVersion-API-Auth.git'
